...
def UserLogin(request):
    if request.method == 'POST':
      ...
      index = 0
      con = pymysql.connect(host='127.0.0.1',port = 3306,user = 'root', password = 'pankaja@2019', database = 'plagiarism',charset='utf8')
      with con:    
          cur = con.cursor()
...
def Signup(request):
    if request.method == 'POST':
      ...
      db_connection = pymysql.connect(host='127.0.0.1',port = 3306,user = 'root', password = 'pankaja@2019', database = 'plagiarism',charset='utf8')
